...
public class DataInitializer implements CommandLineRunner {
    ...
    private void initializeAssignedRoutines() {
        ...
        // Always create fresh test assignments
            ...
            // Use Juan Pérez (ID: 4) as test user
            ...
            if (testUserOpt.isPresent()) {
                ...
                createAssignedRoutine(testUser.getId(), 1, LocalDate.now().minusDays(20), 100, RutinaAsignada.EstadoRutina.COMPLETADA);
                createAssignedRoutine(testUser.getId(), 2, LocalDate.now().minusDays(15), 100, RutinaAsignada.EstadoRutina.COMPLETADA);
                createAssignedRoutine(testUser.getId(), 3, LocalDate.now().minusDays(10), 85, RutinaAsignada.EstadoRutina.ACTIVA);
                createAssignedRoutine(testUser.getId(), 4, LocalDate.now().minusDays(7), 60, RutinaAsignada.EstadoRutina.ACTIVA);
                createAssignedRoutine(testUser.getId(), 5, LocalDate.now().minusDays(5), 40, RutinaAsignada.EstadoRutina.ACTIVA);
                createAssignedRoutine(testUser.getId(), 6, LocalDate.now().minusDays(3), 20, RutinaAsignada.EstadoRutina.ACTIVA);
                createAssignedRoutine(testUser.getId(), 7, LocalDate.now().minusDays(1), 10, RutinaAsignada.EstadoRutina.ACTIVA);
