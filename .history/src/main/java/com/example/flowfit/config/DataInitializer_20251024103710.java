...
public class DataInitializer implements CommandLineRunner {
    ...
    private void fixUserName() {
        System.out.println("Checking and fixing user name...");
        ...
        if (userOpt.isPresent()) {
            ...
            System.out.println("Current user name: " + user.getNombre());
            
            // If name is not "Usuario Test", fix it
            if (!"Usuario Test".equals(user.getNombre())) {
                user.setNombre("Usuario Test");
                usuarioRepository.save(user);
                System.out.println("✅ Fixed user name to: Usuario Test");
            } else {
                System.out.println("✅ User name is already correct: Usuario Test");
            }
        } else {
            System.out.println("❌ User not found with email: usuario@flowfit.com");
        }
    }
}