...
public class DataInitializer implements CommandLineRunner {
    ...
    private void initializeTestUsers() {
        ...
        if (userCount == 0) {
            ...
            testUser.setTipoRol("USUARIO");
            testUser.setEstado("ACTIVO");
            testUser.setFechaNacimiento(LocalDate.of(1990, 1, 15));
            testUser.setGenero("Masculino");
            testUser.setPeso(75.5);
            testUser.setAltura(175);
            testUser.setNivelActividad("INTERMEDIO");
            testUser.setObjetivo("Ganar masa muscular");
            
            usuarioRepository.save(testUser);
            System.out.println("✅ Usuario de prueba creado: " + testUser.getNombre() + " " + testUser.getApellido());
        } else {
            ...
            for (Usuario user : existingUsers) {
                System.out.println("- " + user.getNombre() + " " + user.getApellido() + " (ID: " + user.getId() + ", Rol: " + user.getTipoRol() + ")");
            }
        }
    }
    ...
    private void initializeTestRoutines() {
        ...
        if (rutinaCount == 0) {
            ...
            rutina1.setDificultad("PRINCIPIANTE");
            rutina1.setDuracionMinutos(15);
            rutina1.setCaloriasEstimadas(120);
            rutina1.setCategoria("CARDIO");
            ...
            rutina2.setDificultad("INTERMEDIO");
            rutina2.setDuracionMinutos(30);
            rutina2.setCaloriasEstimadas(150);
            rutina2.setCategoria("FLEXIBILIDAD");
            ...
            for (Rutina rutina : existingRoutines) {
                System.out.println("- " + rutina.getNombre() + " (ID: " + rutina.getId() + ", Dificultad: " + rutina.getDificultad() + ")");
            }
        }
    }
