    ...
    public boolean enviarCorreoResetPassword(String destinatario, String nombreUsuario, String token) {
        try {
            ...
            String contenido = 
                    ...
                    "            <td align='center'>" +
                    "                <table width='600' cellpadding='0' cellspacing='0' border='0' style='max-width: 600px; background: rgba(15, 23, 42, 0.85); backdrop-filter: blur(20px); border: 1px solid rgba(255, 255, 255, 0.1); border-radius: 16px; overflow: hidden; box-shadow: 0 8px 32px rgba(0, 0, 0, 0.3);'>" +
                    "                    <!-- Header con Logo - TEMA AMARILLO SEGURIDAD -->" +
                    "                    <tr>" +
                    "                        <td style='padding: 50px 30px; text-align: center; background: linear-gradient(135deg, rgba(245, 158, 11, 0.12) 0%, rgba(251, 191, 36, 0.08) 100%); border-bottom: 1px solid rgba(245, 158, 11, 0.25);'>" +
                    "                            <!-- Logo FlowFit con círculo blanco de fondo -->" +
                    "                            <div style='margin-bottom: 20px;'>" +
                    "                                <div style='display: inline-block; width: 90px; height: 90px; background: #ffffff; border-radius: 50%; padding: 15px; box-shadow: 0 4px 16px rgba(245, 158, 11, 0.25);'>" +
                    "                                    <img src='cid:flowfitLogo' alt='FlowFit Logo' style='width: 100%; height: 100%; object-fit: contain;' />" +
                    "                                </div>" +
                    "                            </div>" +
                    "                            <h1 style='margin: 10px 0 5px 0; color: #fbbf24; font-size: 32px; font-weight: 800; letter-spacing: -0.5px; text-shadow: 0 0 20px rgba(251, 191, 36, 0.4);'>FlowFit</h1>" +
                    ...
                    "                                Recibimos una solicitud para restablecer la contraseña de tu cuenta en <strong style='color: #fbbf24;'>FlowFit</strong>." +
                    "                            </p>" +
                    "                            " +
                    "                            <!-- Tarjeta de información -->" +
                    "                            <div style='background: rgba(245, 158, 11, 0.08); border: 1px solid rgba(245, 158, 11, 0.2); border-left: 4px solid #f59e0b; border-radius: 12px; padding: 20px; margin: 20px 0;'>" +
                    "                                <p style='margin: 0 0 12px 0; color: #fbbf24; font-size: 14px; font-weight: 600;'>⚡ Acción requerida:</p>" +
                    "                                <p style='margin: 0; color: #cbd5e1; font-size: 14px; line-height: 1.6;'>" +
                    ...
                    "                            <!-- Botón de acción -->" +
                    "                            <div style='text-align: center; margin: 35px 0 30px 0;'>" +
                    "                                <a href='" + resetUrl + "' style='display: inline-block; background: linear-gradient(135deg, #fbbf24 0%, #f59e0b 100%); color: #0f172a; padding: 16px 40px; text-decoration: none; border-radius: 12px; font-weight: 700; font-size: 16px; box-shadow: 0 4px 16px rgba(251, 191, 36, 0.3); transition: all 0.3s ease;'>" +
