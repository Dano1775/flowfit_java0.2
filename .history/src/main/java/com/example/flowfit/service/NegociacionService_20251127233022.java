...
public class NegociacionService {
    ...
    public Map<String, Object> enviarPropuestaInicial(Long conversacionId, Integer entrenadorId, PropuestaDTO propuesta) {
        ...
        try {
            ...
            mensaje.setMetadata(crearMetadataPropuesta(contratacion.getId(), historial.getId(), true, propuesta));
    ...
    private String crearMetadataPropuesta(Long contratacionId, Long historialId, boolean requiereRespuesta, PropuestaDTO propuesta) {
        try {
            ...
            metadata.put("planNutricional", propuesta.isPlanNutricional());
                // Crear preferencia de pago MercadoPago y devolver el link
