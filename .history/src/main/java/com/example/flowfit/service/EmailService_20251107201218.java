    ...
    private String construirMensajeBienvenida(String nombreUsuario, String tipoUsuario) {
        if ("Entrenador".equals(tipoUsuario) || "Nutricionista".equals(tipoUsuario)) {
            ...
            return String.format(
                    ...
                    "                                <img src='cid:flowfitLogo' alt='FlowFit Logo' style='height: 60px; width: auto; display: inline-block;' />" +
                    "                            </div>" +
                    ...
                    "                                        <div style='display: inline-block; width: 80px; height: 80px; background: rgba(251, 191, 36, 0.15); border: 3px solid rgba(251, 191, 36, 0.3); border-radius: 50%%; text-align: center; vertical-align: middle; line-height: 80px;'>" +
            ...
            return String.format(
                    ...
                    "                                <img src='cid:flowfitLogo' alt='FlowFit Logo' style='height: 55px; width: auto;' />" +
                    "                            </div>" +
