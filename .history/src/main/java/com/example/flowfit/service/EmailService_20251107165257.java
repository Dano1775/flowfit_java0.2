    ...
    private String construirMensajeBienvenida(String nombreUsuario, String tipoUsuario) {
        if ("Entrenador".equals(tipoUsuario) || "Nutricionista".equals(tipoUsuario)) {
            ...
            return String.format(
                    ...
                    "                            " +
                    "                            <!-- Saludo con ícono -->" +
                    "                            <div style='background: linear-gradient(135deg, #2d3e50 0%%, #34495e 100%%); border-left: 4px solid #10b981; border-radius: 12px; padding: 20px 25px; margin-bottom: 30px; display: flex; align-items: center;'>" +
                    "                                <svg width='32' height='32' viewBox='0 0 24 24' fill='none' xmlns='http://www.w3.org/2000/svg' style='margin-right: 15px; flex-shrink: 0;'>" +
                    "                                    <path d='M8 12L11 15L16 9M3 12C3 7.02944 7.02944 3 12 3C16.9706 3 21 7.02944 21 12C21 16.9706 16.9706 21 12 21C7.02944 21 3 16.9706 3 12Z' stroke='%2310b981' stroke-width='2' stroke-linecap='round' stroke-linejoin='round'/>" +
                    "                                </svg>" +
                    ...
                    "                            </p>" +
                    "                            " +
                    "                            <!-- Botón CTA Verde con ícono -->" +
                    "                            <div style='text-align: center; margin: 35px 0;'>" +
                    "                                <a href='http://localhost:8080/login' style='display: inline-flex; align-items: center; justify-content: center; background: linear-gradient(135deg, #10b981 0%%, #059669 100%%); color: #ffffff; text-decoration: none; padding: 16px 40px; border-radius: 10px; font-weight: 600; font-size: 16px; box-shadow: 0 4px 12px rgba(16, 185, 129, 0.4);'>" +
                    "                                    <svg width='20' height='20' viewBox='0 0 24 24' fill='none' xmlns='http://www.w3.org/2000/svg' style='margin-right: 10px;'>" +
                    "                                        <path d='M11 16L7 12M7 12L11 8M7 12H21M16 16V17C16 18.6569 14.6569 20 13 20H6C4.34315 20 3 18.6569 3 17V7C3 5.34315 4.34315 4 6 4H13C14.6569 4 16 5.34315 16 7V8' stroke='white' stroke-width='2' stroke-linecap='round' stroke-linejoin='round'/>" +
                    "                                    </svg>" +
                    "                                    Acceder a FlowFit" +
                    "                                </a>" +
                    "                            </div>" +
                    "                            " +
                    "                            <!-- Tarjeta de Consejo con ícono -->" +
                    ...
                    "                                    <svg width='24' height='24' viewBox='0 0 24 24' fill='none' xmlns='http://www.w3.org/2000/svg' style='margin-right: 12px; flex-shrink: 0; margin-top: 2px;'>" +
                    "                                        <path d='M9.663 17H12.5L13 13.5L17.5 8L15 5.5L9.5 10L6 10.5L9.663 17ZM12 3V1M21.66 6.34L23.07 4.93M21 12H23M4.93 6.34L3.52 4.93M4 12H2M7.05 19.93L5.64 21.34M16.95 19.93L18.36 21.34' stroke='%231a2332' stroke-width='2' stroke-linecap='round' stroke-linejoin='round'/>" +
                    "                                    </svg>" +
                    "                                    <div>" +
