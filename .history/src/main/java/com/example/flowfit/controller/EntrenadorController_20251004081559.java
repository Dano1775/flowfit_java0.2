...
public class EntrenadorController {
    ...
    public String asignarRutinasForm(Model model, HttpSession session) {
        ...
        List<AsignacionEntrenador> asignacionesAceptadas = asignacionService.getAsignacionesByEntrenadorAndEstado(
            entrenador.getId(), AsignacionEntrenador.EstadoAsignacion.ACEPTADA);
        
        List<Usuario> usuariosAsignados = asignacionesAceptadas.stream()
        ...
        model.addAttribute("entrenador", entrenador);
        model.addAttribute("rutinas", rutinas);
        model.addAttribute("usuarios", usuariosAsignados);
