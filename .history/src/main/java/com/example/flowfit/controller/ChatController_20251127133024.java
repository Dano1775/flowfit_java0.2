...
public class ChatController {
    ...
    public String verConversacion(@PathVariable Long conversacionId, Model model, HttpSession session) {
        ...
        Conversacion conversacion = chatService.obtenerConversaciones(conversacionId);
        ...
        if (conversacion.getUsuarioId().equals(usuario.getId())) {
            otraPersona = usuarioService.buscarPorId(conversacion.getEntrenadorId());
        } else {
            otraPersona = usuarioService.buscarPorId(conversacion.getUsuarioId());
        }
