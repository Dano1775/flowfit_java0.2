...
public class EntrenadorController {
    ...
    public String asignarRutinasForm(Model model, HttpSession session) {
        ...
        System.out.println("===== DEBUG ASIGNAR RUTINAS =====");
        System.out.println("Entrenador ID: " + entrenador.getId());
        System.out.println("Total rutinas antes de filtrar: " + rutinas.size());
        
        rutinas = rutinas.stream()
                .filter(r -> r.getEntrenadorId() != null && r.getEntrenadorId().equals(entrenador.getId()))
                .collect(Collectors.toList());
        
        System.out.println("Total rutinas después de filtrar: " + rutinas.size());
        rutinas.forEach(r -> System.out.println("  - Rutina: " + r.getId() + " - " + r.getNombre() + " (EntrenadorID: " + r.getEntrenadorId() + ")"));
        ...
        usuarios.forEach(u -> System.out.println("  - Usuario: " + u.getId() + " - " + u.getNombre()));
        System.out.println("================================");
