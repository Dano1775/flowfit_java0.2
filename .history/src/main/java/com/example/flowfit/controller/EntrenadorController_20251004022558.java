...
public class EntrenadorController {
    ...
    public String dashboard(Model model, HttpSession session) {
        ...
        if (entrenador == null || !"Entrenador".equals(entrenador.getPerfil())) {
    ...
    public String crearRutina(@RequestParam String nombre,
        ...
        try {
            ...
            List<EjercicioRutinaDto> ejerciciosRutina = ejercicios.stream()
                .map(ejercicioId -> {
    ...
    public String verRutina(@PathVariable Integer id, Model model, HttpSession session) {
        ...
        try {
            ...
            List<EjercicioRutinaDto> ejercicios = rutinaService.obtenerEjerciciosDeRutina(id);
