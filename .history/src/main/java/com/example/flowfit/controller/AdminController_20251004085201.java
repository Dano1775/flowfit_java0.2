...
public class AdminController {
    ...
    public String eliminarUsuario(@PathVariable Integer id, 
        ...
        try {
            ...
            historial.setAdministrador(admin);
            historial.setFechaEdicion(LocalDateTime.now());
            historial.setCamposModificados("USUARIO ELIMINADO - Nombre: " + nombreUsuario + ", Perfil: " + perfilUsuario);
            historial.setTipoAccion("ELIMINACIÓN");
            historialEdicionesRepository.save(historial);
