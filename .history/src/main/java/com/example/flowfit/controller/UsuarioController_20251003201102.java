...
public class UsuarioController {
    ...
    public String verDetallesRutina(@RequestParam Integer rutinaId,
        ...
        try {
            ...
            // Obtener ejercicios de la rutina usando el método existente
            List<RutinaEjercicio> ejerciciosRutina = rutinaService.obtenerEjerciciosConDetalles(rutinaId);
            
            // Verificar si el usuario tiene esta rutina asignada usando el método existente
            Optional<RutinaAsignada> rutinaAsignadaOpt = rutinaService.asignarRutina(usuario.getId(), rutinaId);
            RutinaAsignada rutinaAsignada = rutinaAsignadaOpt.orElse(null);
