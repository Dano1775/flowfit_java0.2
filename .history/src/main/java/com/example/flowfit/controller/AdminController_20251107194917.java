...
public class AdminController {
    ...
    public String usuarios(@RequestParam(defaultValue = "") String search,
        ...
        try {
            ...
            // DEBUG: Log después de filtros
            System.out.println("📊 ESTADÍSTICAS CALCULADAS:");
            System.out.println("  Total usuarios después de filtros: " + totalUsuarios);
            System.out.println("  Usuarios Activos: " + usuariosActivos);
            System.out.println("  Usuarios Pendientes: " + usuariosPendientes);
            System.out.println("  Usuarios Rechazados: " + usuariosRechazados);
