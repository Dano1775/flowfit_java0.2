...
public class UsuarioController {
    ...
    public String verDetallesRutina(@RequestParam Integer rutinaId,
        ...
        try {
            ...
            List<EjercicioCatalogo> ejerciciosRutina = rutinaService.obtenerEjerciciosPorRutina(rutinaId);
            
            // Verificar si el usuario tiene esta rutina asignada
            RutinaAsignada rutinaAsignada = rutinaService.obtenerRutinaAsignadaPorUsuarioYRutina(usuario.getId(), rutinaId);
