            ...
            <div class="mb-3" style="background: rgba(255, 255, 255, 0.03); border: 1px solid rgba(255, 255, 255, 0.1); border-left: 4px solid #10b981; border-radius: 12px; padding: 1.5rem; transition: all 0.3s cubic-bezier(0.4, 0, 0.2, 1); position: relative; overflow: hidden;">
              <div class="d-flex gap-3">
                ...
                <div class="flex-grow-1">
                  ...
                  ${desc ? '<p class="text-muted small mb-3" style="line-height: 1.6;">' + desc + '</p>' : ''}
                  
                  <!-- Imagen del ejercicio -->
                  ${ej.ejercicioImagen ? '<div class="mb-3"><img src="' + ej.ejercicioImagen + '" alt="' + nombre + '" class="img-fluid rounded" style="max-height: 200px; object-fit: cover;" onerror="this.style.display=\'none\'"></div>' : ''}
                  ...
                  <!-- Notas -->
                  ${ej.notas ? '<div class="mt-2"><small class="text-muted"><i class="bi bi-sticky me-1"></i>' + ej.notas + '</small></div>' : ''}
                </div>
              </div>
            </div>
          `;
