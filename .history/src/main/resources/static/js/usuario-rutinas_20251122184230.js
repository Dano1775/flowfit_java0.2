            ...
            <div class="mb-3" style="background: rgba(255, 255, 255, 0.03); border: 1px solid rgba(255, 255, 255, 0.1); border-left: 4px solid #10b981; border-radius: 12px; padding: 1.5rem; transition: all 0.3s cubic-bezier(0.4, 0, 0.2, 1); position: relative; overflow: hidden;">
              <div class="d-flex gap-3">
                ...
                <div class="flex-grow-1">
                  ...
                  ${imagenUrl ? '<div class="mb-3"><img src="' + imagenUrl + '" alt="' + nombre + '" class="img-fluid rounded" style="max-height: 250px; width: 100%; object-fit: cover; border: 2px solid rgba(16, 185, 129, 0.3);" onerror="console.error(\'Error cargando imagen:\', this.src); this.parentElement.style.display=\'none\'"></div>' : ''}
