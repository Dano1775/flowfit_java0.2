...
function abrirModalDetalles(rutinaId) {
  ...
  fetch('/usuario/api/rutinas/' + rutinaId)
    ...
    .then(data => {
      ...
      const modalBody = document.querySelector('#rutinaDetallesModal .modal-body');
      ...
      // Insertar después del contenido de carga pero antes de la lista de ejercicios
      const contenidoModal = document.getElementById('modalContenido');
      let listaEjercicios = document.getElementById('modalEjerciciosLista');
      contenidoModal.insertBefore(infoAdicional, listaEjercicios);
      
      // Lista de ejercicios
      listaEjercicios = document.getElementById('modalEjerciciosLista');
