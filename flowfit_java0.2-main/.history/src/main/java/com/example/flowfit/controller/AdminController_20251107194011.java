...
public class AdminController {
    ...
    public String usuarios(@RequestParam(defaultValue = "0") int page,
        ...
        try {
            ...
            // DEBUG: Log para verificar usuarios obtenidos
            System.out.println("═══════════════════════════════════════");
            System.out.println("🔍 DEBUG CONTROLADOR USUARIOS");
            System.out.println("Total usuarios obtenidos de BD: " + todosUsuarios.size());
            for (Usuario u : todosUsuarios) {
                System.out.println("  - ID: " + u.getId() + ", Nombre: " + u.getNombre() + ", Perfil: " + u.getPerfilUsuario() + ", Estado: " + u.getEstado());
            }
            System.out.println("═══════════════════════════════════════");
