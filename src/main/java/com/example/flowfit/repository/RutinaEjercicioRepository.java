...
public interface RutinaEjercicioRepository extends JpaRepository<RutinaEjercicio, Integer> {
       ...
       // Un ejercicio concreto dentro de una rutina
       RutinaEjercicio findByRutinaIdAndEjercicioId(Integer rutinaId, Integer ejercicioId);

       // Ejercicios de una rutina filtrados por día del ciclo
       List<RutinaEjercicio> findByRutinaIdAndDiaOrdenOrderByOrdenAsc(Integer rutinaId, Integer diaOrden);

       // Ejercicios de una rutina por lista de ejercicios (para multi-día)
       List<RutinaEjercicio> findByRutinaIdAndEjercicioIdInOrderByOrdenAsc(Integer rutinaId,
                     List<Integer> ejercicioIds);
        ...
        * "ORDER BY re.orden")
        * List<RutinaEjercicio> findEjerciciosConDetalles(@Param("rutinaId") Integer
        * rutinaId);
        */
