...
-- Mostrar rutinas con ejercicios
SELECT 
    r.nombre as rutina,
    ...
    re.orden
FROM rutina r
JOIN rutina_ejercicio re ON r.id = re.rutina_id
JOIN ejercicio_catalogo e ON re.ejercicio_id = e.id
ORDER BY r.id, re.orden;

-- =============================================
-- FIN DEL SCRIPT
-- =============================================
-- Base de datos FlowFit configurada correctamente
-- Total de rutinas: 8
-- Total de ejercicios: 14  
